  ...
  <header class="text-gray-600 body-font">
    <div class="container mx-auto flex flex-wrap py-5 flex-col md:flex-row items-center">
      <NuxtLink class="flex title-font font-medium items-center text-gray-900 mb-4 md:mb-0 hove:underline" to="/">
        <span class="m-0 md:ml-3 text-2xl font-bold text-[#1E1E1E] tracking-wider">
          Danilo Pinotti
        </span>
      </NuxtLink>
      <nav class="md:ml-auto flex flex-wrap items-center text-base justify-center gap-3 md:gap-4 font-bold">
